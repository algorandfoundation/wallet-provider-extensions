...
export default function Accounts() {
    ...
    const handleGenerateAccount = async () => {
        ...
        // Simplified account generation for the example
        // In a real app, this would use the keystore to derive a key and then add it to the account store
        ...
        try {
            ...
            // The account store bridge (WithAccountsKeystore) should automatically pick this up
            // but we can also manually add if needed. Assuming autoPopulate is on.
            console.log('Generated key for account:', keyId);
        } catch (error: any) {
                            ...
                            >
                                <View style={styles.accountCard}>
                                    <View style={styles.accountInfo}>
                                        <View style={[styles.accountIconContainer, { backgroundColor: `${parentColor}15` }]}>
                                        ...
                                        <View style={{ flex: 1 }}>
                                            <Text style={[styles.accountAddress, { color: parentColor, fontWeight: 'bold' }]} numberOfLines={1} ellipsizeMode="middle">
                                                {item.address}
                                            </Text>
                                            {item.metadata?.name && (
