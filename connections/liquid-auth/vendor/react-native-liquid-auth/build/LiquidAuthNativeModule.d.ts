...
declare class LiquidAuthNativeModule extends NativeModule<LiquidAuthNativeModuleEvents> {
     ...
     */
    connect(requestId: string, type: LiquidAuthPeerType, iceServers?: IceServer[], options?: LiquidAuthConnectOptions): Promise<void>;
    /**
     ...
     */
    request(url: string, method: string, headers?: Record<string, string>, body?: string): Promise<LiquidAuthResponse>;
}
declare const _default: LiquidAuthNativeModule;
export default _default;
//# sourceMappingURL=LiquidAuthNativeModule.d.ts.map